...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1668900162534058298L;
   ...
   */
  public static guru.learningjournal.kafka.examples.types.LineItem.Builder newBuilder() {
    return new guru.learningjournal.kafka.examples.types.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static guru.learningjournal.kafka.examples.types.LineItem.Builder newBuilder(guru.learningjournal.kafka.examples.types.LineItem.Builder other) {
    if (other == null) {
      return new guru.learningjournal.kafka.examples.types.LineItem.Builder();
    } else {
      return new guru.learningjournal.kafka.examples.types.LineItem.Builder(other);
    }
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static guru.learningjournal.kafka.examples.types.LineItem.Builder newBuilder(guru.learningjournal.kafka.examples.types.LineItem other) {
    if (other == null) {
      return new guru.learningjournal.kafka.examples.types.LineItem.Builder();
    } else {
      return new guru.learningjournal.kafka.examples.types.LineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guru.learningjournal.kafka.examples.types.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guru.learningjournal.kafka.examples.types.LineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.itemCode)) {
        this.itemCode = data().deepCopy(fields()[0].schema(), other.itemCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder clearItemCode() {
      itemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder clearItemPrice() {
      itemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder clearItemQty() {
      itemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.types.LineItem.Builder clearTotalValue() {
      totalValue = null;
