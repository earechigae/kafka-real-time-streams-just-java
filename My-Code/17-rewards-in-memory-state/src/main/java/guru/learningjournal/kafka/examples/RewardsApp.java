...
public class RewardsApp {
    ...
    public static void main(String[] args) {
        ...
        //The through() function allows repartitioning.
        //In this case it is necessary to repartition to send the same customer to the same partition, no matter what pos
        //the customer uses. Notice it uses an intermediate topic name: AppConfigs.REWARDS_TEMP_TOPIC
        //Repartitioning is expensive in terms of resources.
