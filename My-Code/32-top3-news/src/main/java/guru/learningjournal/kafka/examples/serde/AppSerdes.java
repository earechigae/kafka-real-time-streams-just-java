...
import guru.learningjournal.kafka.examples.Top3NewTypes;
...
public class AppSerdes extends Serdes {
    ...
    static final class Top3NewsTypesSerde extends WrapperSerde<Top3NewTypes> {
        Top3NewsTypesSerde() {
            super(new JsonSerializer<>(), new JsonDeserializer<>());
        }
    }

    public static Serde<Top3NewTypes> Top3NewsTypes(){
        Top3NewsTypesSerde serde = new Top3NewsTypesSerde();

        Map<String, Object> serdeConfigs = new HashMap<>();
        serdeConfigs.put(JsonDeserializer.VALUE_CLASS_NAME_CONFIG, Top3NewTypes.class);
        serde.configure(serdeConfigs, false);
