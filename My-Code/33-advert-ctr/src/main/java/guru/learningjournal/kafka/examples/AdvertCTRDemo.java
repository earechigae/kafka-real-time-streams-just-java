...
public class AdvertCTRDemo {
    ...
    public static void main(String[] args) {
        ...
        // We can join 2 KTables and combine the data from both tables in a different object like CampaignPerformance
        KTable<String, CampaignPerformance> campaignPerformance = adImpressionCount
                .leftJoin(
                        // KTable to join
                        adClickCount,
                        // Value Joiner
